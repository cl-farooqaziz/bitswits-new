        ...
        <>
            ...
            <section className={styles.newHomeBg}>
                ...
                <Container>
                    ...
                    <Row>
                        <Col xl={12}>
                            <p modern digital factory className={`${styles.just} ${styles.just2} text-center f-20 font-bold mb-2 mb-lg-0`}>A Top</p>
                            ...
                            <p className={`${styles.just} text-center f-14 mb-4 mb-lg-0`}>We deliver great results, on time and on budget. Contact usto start talking about your project today!</p>
