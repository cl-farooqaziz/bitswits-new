            ...
            <Container fluid>
                <Row className={styles.bannnerproject}>
                    <Col lg={7}>
                        ...
                        <p className='font25 black fontf font-medium line30'>We deliver great results, on time and on budget. <br></br> Contact us to start talking about your project today!</p>
