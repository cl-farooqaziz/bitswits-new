                        ...
                        <Col xl={12}>
                            ...
                            {activeTab1 == 'tab2' &&
                                ...
                                <div className={styles.newyork}>
                                    ...
                                    <div>
                                        <Image src={frontend1} className='img-fluid' />
                                        <p>Angular js</p>
                                    </div>
                                    <div>
                                        <Image src={frontend2} className='img-fluid' />
                                        <p>React js</p>
                                    </div>
                                    <div>
                                        <Image src={frontend3} className='img-fluid' />
                                        <p>Typescript</p>
                                    </div>
                                    <div>
                                        <Image src={frontend4} className='img-fluid' />
                                        <p>Vue</p>
                                    </div>
                                    <div>
                                        <Image src={frontend5} className='img-fluid' />
                                        <p>Wpf</p>
                                    </div>

                                    <div>
                                        <Image src={frontend6} className='img-fluid' />
                                        <p>Html5</p>
                                    </div>
                            ...
                            {activeTab1 == 'tab3' &&
                                ...
                                <div className={styles.newyork}>
                                    ...
                                    <div>
                                        <Image src={database1} className='img-fluid' />
                                        <p>Mongo db</p>
                                    </div>
                                    <div>
                                        <Image src={database2} className='img-fluid' />
                                        <p>Mysql</p>
                                    </div>
                                    <div>
                                        <Image src={database3} className='img-fluid' />
                                        <p>Mssql</p>
                                    </div>
                                    <div>
                                        <Image src={database4} className='img-fluid' />
                                        <p>Firebase</p>
                                    </div>
                                    <div>
                                        <Image src={database5} className='img-fluid' />
                                        <p>Dynamodb</p>
                                    </div>

                                    <div>
                                        <Image src={database6} className='img-fluid' />
                                        <p>Redis</p>
                                    </div>
                            ...
                            {activeTab1 == 'tab4' &&
                                ...
                                <div className={styles.newyork}>
                                    ...
                                    <div>
                                        <Image src={php1} className='img-fluid' />
                                        <p>Php</p>
                                    </div>
                                    <div>
                                        <Image src={php2} className='img-fluid' />
                                        <p>Java</p>
                                    </div>
                                    <div>
                                        <Image src={php3} className='img-fluid' />
                                        <p>Node .js</p>
                                    </div>
                            ...
                            {activeTab1 == 'tab5' &&
                                ...
                                <div className={styles.newyork}>
                                    ...
                                    <div>
                                        <Image src={cms1} className='img-fluid' />
                                        <p>Wordpress</p>
                                    </div>
                                    <div>
                                        <Image src={cms2} className='img-fluid' />
                                        <p>Magento</p>
                                    </div>
                                    <div>
                                        <Image src={cms3} className='img-fluid' />
                                        <p>Shopify</p>
                                    </div>
                            ...
                            {activeTab1 == 'tab6' &&
                                ...
                                <div className={styles.newyork}>
                                    ...
                                    <div>
                                        <Image src={dev1} className='img-fluid' />
                                        <p>Aws</p>
                                    </div>
                                    <div>
                                        <Image src={dev2} className='img-fluid' />
                                        <p>Gradle</p>
                                    </div>
                                    <div>
                                        <Image src={dev3} className='img-fluid' />
                                        <p>Jenkins</p>
                                    </div>
                                    <div>
                                        <Image src={dev4} className='img-fluid' />
                                        <p>Appium</p>
                                    </div>
                                    <div>
                                        <Image src={dev5} className='img-fluid' />
                                        <p>Selenium</p>
                                    </div>

                                    <div>
                                        <Image src={dev6} className='img-fluid' />
                                        <p>Azure</p>
                                    </div>
                                    <div>
                                        <Image src={dev7} className='img-fluid' />
                                        <p>Digital ocean</p>
                                    </div>
                                    <div>
                                        <Image src={dev8} className='img-fluid' />
                                        <p>Rackspace</p>
                                    </div>
                                    <div>
                                        <Image src={dev9} className='img-fluid' />
                                        <p>Linode</p>
                                    </div>
