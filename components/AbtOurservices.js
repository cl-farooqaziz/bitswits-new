                        ...
                        <Col lg={12}>
                            <Accordion defaultActiveKey="0">
                                <Accordion.Item eventKey="0">
                                    <Accordion.Header>
                                        <Image alt="bitswits"   src={icon1} alt='bitswits' className='img-fluid' />
                                    	Innovation
                                    </Accordion.Header>
                                    <Accordion.Body>
                                ...
                                <Accordion.Item eventKey="1">
                                    <Accordion.Header>
                                        <Image alt="bitswits"   src={icon2} alt='bitswits' className='img-fluid' />
                                        Timely Delivery
                                    </Accordion.Header>
                                    <Accordion.Body>
                                ...
                                <Accordion.Item eventKey="2">
                                    <Accordion.Header>
                                        <Image alt="bitswits"   src={icon3} alt='bitswits' className='img-fluid' />
                                        Quick Collaboration 
                                    </Accordion.Header>
                                    <Accordion.Body>
                                ...
                                <Accordion.Item eventKey="3">
                                    <Accordion.Header>
                                        <Image alt="bitswits"   src={icon4} alt='bitswits' className='img-fluid' />
                                ...
                                <Accordion.Item eventKey="4">
                                    <Accordion.Header>
                                        <Image alt="bitswits"   src={icon5} alt='bitswits' className='img-fluid' />
