            ...
            <section className={styles.sign}>
                <Container>
                    ...
                    <Row className='mt-4'>
                        ...
                        <Col lg={6}>
                            <h2 className='f-30 f-700 black'>We Ideate, Design, and Construct Expressive Games!!!</h2>
                            <p className='f-16 f-500 black'>BitsWits bring your visions into gaming reality following a structured and mindful approach.</p>
                            <p className='f-16 f-500 black'>Our ideation process starts by exploring potential themes and genres to create an ideal design concept. We then move on to planning out the game's structure and detailing the game design document. Once the plan is locked in, we move on to building the game prototype. Our team works in tandem to create the basic visuals and gameplay for the game with all features intact. The end result is nothing short of amazing - a game that best aligns with the interests and goals of the client and functions seamlessly!</p>
                    ...
                    <Row className='mt-4'>
                        <Col lg={6}>
                            ...
                            <p className='f-16 f-500 black'>Now the hunger for games will see no bounds since our UI/UX experiences serve as an appetizing course of a meal for gaming enthusiasts!</p>
                    ...
                    <Row className='mt-4'>
                        ...
                        <Col lg={6}>
                            <h2 className='f-30 f-700 black'>We Utilize Cutting-Edge Mobile Gaming Technologies!!!</h2>
                            <p className='f-16 f-500 black'>BitsWits collar the intricacies of mobile gaming technology and help develop a strategy for success. We use cutting-edge software, languages, and frameworks; you can enjoy superior graphics and sound that bring every battle, mission, or quest to life. Our innovative network protocols will keep your game running smoothly with low latency and excellent responsiveness.</p>
                            <p className='f-16 f-500 black'>At the same time, our advanced security technologies protect your data and privacy against malicious forces and hackers. Last but not least, our hardware-based encryption ensures that all your gaming progress is safe from prying eyes. How much better some game development company can become by leveraging innovation? Hit us up with your requirements, and VOILA, you are already halfway through the blazing-fast success!</p>
                    ...
                    <Row className='mt-4'>
                        <Col lg={6}>
                            ...
                            <p className='f-16 f-500 black'>Simply put, BitsWits works behind the scenes to guarantee that your gaming experience is a success. With us, rest assured that your game will hit the market on time, with the highest quality possible. Contact us today, and let's get the ball rolled!</p>
