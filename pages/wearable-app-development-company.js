...
// banner component data
    const heading = <h1 className='font65 black fontf font-bold line60'>The Top <span className='grdiant'>Wearable App Development Company </span></h1>
    ...
    <Row className='justify-content-center align-items-center text-center mb-4'>
        <Col lg={12}>
            <h2>Benefits of Working with a Leading
                <br/>
              <span className='font-bold'> Wearable App Development Company</span> 
            </h2>
...
<Row className='text-center'>
    <Col lg={12}>
        <h4 className='font40'>Our <span className='font-bold'> Wearable App Development</span> Process</h4>
