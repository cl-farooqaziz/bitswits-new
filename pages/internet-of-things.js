...
export default function internetofthings() {
    ...
    const para = <p className='black fontf font-medium line30'>
        BitsWits, a top <spna className='grdiant'>Internet of Things development company</spna>, specializes in delivering all sorts of solutions and attractive app designs. Our <span className='grdiant'>IoT services</span> focus on providingIoT-enabled products, solutions, and services, and also help businesses collect and analyze data, and deliver valuable insights and functionality. Our <span className='grdiant'>IoT app developers</span> use approaches that ensure simplicity and professionalism, allowing you to stand out in the market. So, what are you waiting for? 
