...
import b2b1 from '../public/images/benefits/b2b1.png'
import b2b2 from '../public/images/benefits/b2b2.png'
import b2b3 from '../public/images/benefits/b2b3.png'
import b2b4 from '../public/images/benefits/b2b4.png'
import b2b5 from '../public/images/benefits/b2b5.png'
import b2b6 from '../public/images/benefits/b2b6.png'
import b2b7 from '../public/images/benefits/b2b7.png'
import b2b8 from '../public/images/benefits/b2b8.png'

import b1 from '../public/images/benefits/b1.jpg'
import b2 from '../public/images/benefits/b2.jpg'
import b3 from '../public/images/benefits/b3.jpg'
import b4 from '../public/images/benefits/b4.jpg'
import b5 from '../public/images/benefits/b5.jpg'
import b6 from '../public/images/benefits/b6.jpg'
import b7 from '../public/images/benefits/b7.jpg'
import b8 from '../public/images/benefits/b8.jpg'

// import why9 from '../public/images/benefits/why9.png'
// import why10 from '../public/images/benefits/why10.png'
// import why11 from '../public/images/benefits/why11.png'
// import why12 from '../public/images/benefits/why12.png'
...
export default function travelhospitality() {
    ...
    const heading = <h1 className='font65 black fontf font-bold line60'>The Best Design and <br /><span className='grdiant'> B2B SOLUTIONS </span> Company!</h1>

    const para = <>

        <ul className='p-0'>
            <li className="font16 fontf font-medium black "> <Image src={mobilearrow} className='img-fluid multi'></Image>Customer Service </li>
            <li className="font16 fontf font-medium black "> <Image src={mobilearrow} className='img-fluid multi'></Image>Analysis </li>
            <li className="font16 fontf font-medium black "> <Image src={mobilearrow} className='img-fluid multi'></Image>Marketing </li>
            <li className="font16 fontf font-medium black "> <Image src={mobilearrow} className='img-fluid multi'></Image>Finance </li>
            <li className="font16 fontf font-medium black "> <Image src={mobilearrow} className='img-fluid multi'></Image>CRM </li>
            <li className="font16 fontf font-medium black "> <Image src={mobilearrow} className='img-fluid multi'></Image>Implementation </li>
            <li className="font16 fontf font-medium black "> <Image src={mobilearrow} className='img-fluid multi'></Image>Sale </li>
        </ul>
    </>
  ...
  const exmplTitle = <> <h2 className='font40 black fontf font-bold line60 black text-center mb-3'>Some examples of our <span className='grdiant'>B2B </span> solutions
  </h2> </>
  ...
  const exmplText = <> <span>Let's talk about your Automotive  requirements </span> </>
...
const experttitle = <h4 className='font40 black fontf font-bold line60 black text-center'>B2B Solutions with the Experts
</h4>
        ...
        <Row>
            <Col lg={3}>
                ...
                <Image src={b1} alt='BitsWits' className='img-fluid' />
                  <h4>50+CRM EXPERIENCED PROFESSIONALS</h4>  
                </div>
            </Col>
            <Col lg={3}>
                <div className={expertStyle.exebox}>
...
//           <div className={`${whyStyles.soluCard}`}>
//               <div className={`${whyStyles.imgBox}`}>
//                   <Image src={why1} alt='BitsWits' className='img-fluid' />
//               </div>
//               <h5 className='font20 fontf font-500 line30'>
//               21+ years experience in the industry
//               </h5>
//           </div>
//       </Col>
//       <Col lg={3} md={4} className={whyStyles.soluCol}>
//           <div className={`${whyStyles.soluCard}`}>
//               <div className={`${whyStyles.imgBox}`}>
//                   <Image src={why2} alt='BitsWits' className='img-fluid' />
//               </div>
//               <h5 className='font20 fontf font-500 line30'>
...
//           <div className={`${whyStyles.soluCard}`}>
//               <div className={`${whyStyles.imgBox}`}>
//                   <Image src={why3} alt='BitsWits' className='img-fluid' />
//               </div>
//               <h5 className='font20 fontf font-500 line30'>
...
//           <div className={`${whyStyles.soluCard}  ${whyStyles.soluCardBR}`}>
//               <div className={`${whyStyles.imgBox}`}>
//                   <Image src={why4} alt='BitsWits' className='img-fluid' />
//               </div>
//               <h5 className='font20 fontf font-500 line30'>
...
//           <div className={`${whyStyles.soluCard}`}>
//               <div className={`${whyStyles.imgBox}`}>
//                   <Image src={why5} alt='BitsWits' className='img-fluid' />
//               </div>
//               <h5 className='font20 fontf font-500 line30'>
...
//           <div className={`${whyStyles.soluCard}`}>
//               <div className={`${whyStyles.imgBox}`}>
//                   <Image src={why6} alt='BitsWits' className='img-fluid' />
//               </div>
//               <h5 className='font20 fontf font-500 line30'>
...
//           <div className={`${whyStyles.soluCard} `}>
//               <div className={`${whyStyles.imgBox}`}>
//                   <Image src={why7} alt='BitsWits' className='img-fluid' />
//               </div>
//               <h5 className='font20 fontf font-500 line30'>
...
//           <div className={`${whyStyles.soluCard}  ${whyStyles.soluCardBR}`}>
//               <div className={`${whyStyles.imgBox}`}>
//                   <Image src={why8} alt='BitsWits' className='img-fluid' />
//               </div>
//               <h5 className='font20 fontf font-500 line30'>
...
//               <div className={`${whyStyles.imgBox}`}>
//                   <Image src={why9} alt='BitsWits' className='img-fluid' />
//               </div>
//               <h5 className='font20 fontf font-500 line30'>
...
//           <div className={`${whyStyles.soluCard} ${whyStyles.soluCardBB}`}>
//               <div className={`${whyStyles.imgBox}`}>
//                   <Image src={why10} alt='BitsWits' className='img-fluid' />
//               </div>
//               <h5 className='font20 fontf font-500 line30'>
...
//           <div className={`${whyStyles.soluCard} ${whyStyles.soluCardBB}`}>
//               <div className={`${whyStyles.imgBox}`}>
//                   <Image src={why11} alt='BitsWits' className='img-fluid' />
//               </div>
//               <h5 className='font20 fontf font-500 line30'>
...
//               <div className={`${whyStyles.imgBox}`}>
//                   <Image src={why12} alt='BitsWits' className='img-fluid' />
//               </div>
//               <h5 className='font20 fontf font-500 line30'>
