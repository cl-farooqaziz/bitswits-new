        ...
        <Row className={`${whyStyles.soluRow} mt-5`}>
            <Col lg={4} md={6} className={whyStyles.soluCol}>
                <div className={`${whyStyles.soluCard}`}>
                    ...
                    <h5 class="font20 fontf font-bold line30">Performance Optimisation</h5>
                    <p>
            ...
            <Col lg={4} md={6} className={whyStyles.soluCol}>
                <div className={`${whyStyles.soluCard}`}>
                    ...
                    <h5 class="font20 fontf font-bold line30">Custom Applications</h5>
                    <p>
            ...
            <Col lg={4} md={6} className={whyStyles.soluCol}>
                <div className={`${whyStyles.soluCard} ${whyStyles.soluCardBR}`}>
                    ...
                    <h5 class="font20 fontf font-bold line30">Startup Solutions</h5>
                    <p>
            ...
            <Col lg={4} md={6} className={whyStyles.soluCol}>
                <div className={`${whyStyles.soluCard} `}>
                    ...
                    <h5 class="font20 fontf font-bold line30">Established Business Solutions</h5>
                    <p>
            ...
            <Col lg={4} md={6} className={whyStyles.soluCol}>
                <div className={`${whyStyles.soluCard} `}>
                    ...
                    <h5 class="font20 fontf font-bold line30">Solutions Across Industries</h5>
                    <p>
            ...
            <Col lg={4} md={6} className={whyStyles.soluCol}>
                <div className={`${whyStyles.soluCard} ${whyStyles.soluCardBR}`}>
                    ...
                    <h5 class="font20 fontf font-bold line30">B2b Solutions</h5>
                    <p>
            ...
            <Col lg={4} md={6} className={whyStyles.soluCol}>
                <div className={`${whyStyles.soluCard} ${whyStyles.soluCardBB}`}>
                    ...
                    <h5 class="font20 fontf font-bold line30">B2c Solutions</h5>
                    <p>
            ...
            <Col lg={4} md={6} className={whyStyles.soluCol}>
                <div className={`${whyStyles.soluCard} ${whyStyles.soluCardBB}`}>
                    ...
                    <h5 class="font20 fontf font-bold line30">Headless Drupal Development</h5>
                    <p>
            ...
            <Col lg={4} md={6} className={whyStyles.soluCol}>
                <div className={`${whyStyles.soluCard} ${whyStyles.soluCardBB} ${whyStyles.soluCardBR}`}>
                    ...
                    <h5 class="font20 fontf font-bold line30">Integration With Third-Party Apis</h5>
                    <p>
