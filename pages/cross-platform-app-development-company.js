...
export default function aboutUs() {
    ...
    const heading = <h1 className='font65 black fontf font-bold line60'>The Best Design and <br /><span className='grdiant'> Cross Platform App
     </span> Development Company!</h1>

    const para = <>

        <ul className='p-0'>
            <li className="font16 fontf font-medium mt-3 black mb-2"> <Image src={mobilearrow} className='img-fluid multi'></Image> Multi Browser Compatabilitiy </li>
